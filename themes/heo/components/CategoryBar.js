  ...
  return (
    <div
      ...
      className={`wow fadeInUp flex flex-nowrap justify-between items-center h-12 mb-4 space-x-2 w-full lg:bg-white dark:lg:bg-[#1e1e1e]  
            ${border ? 'lg:border lg:hover:border dark:lg:border-gray-800 hover:border-indigo-600 dark:hover:border-yellow-600 ' : ''}  py-2.5 lg:px-4 rounded-3xl transition-colors duration-200`}>
      <div
...
const MenuItem = ({ href, name }) => {
  ...
  console.log("selected:", selected, "category:", category, router.query)
  return (
    <div
